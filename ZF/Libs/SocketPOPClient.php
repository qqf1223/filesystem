...
class ZF_Libs_SocketPOPClient
{
    ...
    * 基础操作，构造函数
    * 
    * @param mixed $strLoginEmail
    * @param mixed $strLoginPasswd
    * @param mixed $strPopHost
    * @param mixed $intPort
    */
